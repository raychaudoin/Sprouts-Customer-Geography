...
TASK_ID_RE = re.compile(
    r"^(?:GOV|DATA|MODEL|GEO|BI|PBI|PIPE|STORE|MARKETS|INTEGRATION|DEPLOY|VALIDATE)-[0-9]{2}[A-Z]?$"
)
BRANCH_RE = re.compile(r"^task/[a-z]+-[0-9]{2}[a-z]?(?:-[a-z0-9]+)+$")
COMMIT_RE = re.compile(r"^(?:GOV|DATA|MODEL|GEO|BI|PBI|PIPE|STORE|MARKETS|INTEGRATION|DEPLOY|VALIDATE)-[0-9]{2}[A-Z]?: [a-z].+$")
PR_TITLE_RE = re.compile(r"^(?:GOV|DATA|MODEL|GEO|BI|PBI|PIPE|STORE|MARKETS|INTEGRATION|DEPLOY|VALIDATE)-[0-9]{2}[A-Z]?: \S.*$")
